...
export const buildCrisisState = ({ lang = "zh", assessment = {}, checkIns = [], careLevel }) => {
  ...
  return {
    ...
    desc:
      riskAssessment?.alert?.level === ALERT_LEVELS.URGENT
        ? pickText(
            lang,
            {
              zh: "检测到安全风险，请立即联系专业人员并通知伴侣或家人。",
              en: "Safety risk detected. Contact a professional now and alert partner or family.",
            }
          )
        : pickText(
            lang,
            {
              zh: "近期综合风险持续偏高，请先完成转介、安全计划和专业随访。",
